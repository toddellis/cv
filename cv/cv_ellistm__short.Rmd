...
As at `r Sys.Date()`, I have `r ACADEMIC_SUMMARY$pub_count` peer-reviewed publications with an h-index of `r ACADEMIC_SUMMARY$h_index`. I am the first author on `r ACADEMIC_SUMMARY$pub_count_first` of these publications and have received a total of `r ACADEMIC_SUMMARY$citations_scopus` or `r ACADEMIC_SUMMARY$citations_gscholar` citations based on Scopus and Google Scholar, respectively.
